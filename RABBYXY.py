...
# Set window title
sys.stdout.write('\x1b]2;𓆩【RABBY 👑 】𓆪 \x07')
os.system("clear")
def pro_banner():
    return """
\033[1;32m
...
class BGRICracker:
    ...
    def old_menu(self):
        ...
        print(f"{self.color.P}╠═━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━═╣")
        print(f"{self.color.P}║ {self.color.C}[1] {self.color.G}CRACK 2009-2013 ACCOUNTS                 {self.color.P}║")
        print(f"{self.color.P}║ {self.color.C}[2] {self.color.G}CRACK 2016-2019 ACCOUNTS            {self.color.P}║")
    ...
    def breach_target(self, target, passlist):
        self.loop += 1
        sys.stdout.write(f'\r  {self.color.W}[RABBY] {self.loop}|{self.color.R}{len(self.oks)}|{self.color.G}{len(self.cps)}{self.color.W}')
        sys.stdout.flush()
    ...
    def handle_success(self, uid, password, response):
        ...
        with open('/sdcard/RABBY.txt', 'a') as f:
    ...
    def handle_partial(self, uid, password):
        ...
        with open('/sdcard/RABBY-OLD.txt', 'a') as f:
...
if __name__ == "__main__":
    try:
        clear()
        print("✅ TOOL UNLOCKED (NO KEY REQUIRED)\n")
        cracker = BGRICracker()
        cracker.old_menu()
